...
export class AddFeedbacks1746623646836 implements MigrationInterface {
    name = 'AddFeedbacks1746623646836'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","product_statistics","public"]);
        await queryRunner.query(`DROP VIEW IF EXISTS "product_statistics"`);
        await queryRunner.query(`ALTER TABLE "feedbacks" ADD "productId" integer`);
        await queryRunner.query(`ALTER TABLE "feedbacks" ADD CONSTRAINT "FK_8417be32ff262c67eada76acb56" FOREIGN KEY ("productId") REFERENCES "products"("productId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "feedbacks" DROP CONSTRAINT "FK_8417be32ff262c67eada76acb56"`);
        await queryRunner.query(`ALTER TABLE "feedbacks" DROP COLUMN "productId"`);
        }
